    ...
    <div class="table-container">
        ...
        <table>
            ...
            <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php if (!isItemUsed($item['id'], $pdo)): ?>
                                    <a href="delete_item.php?id=<?php echo $item['id']; ?>" class="btn btn-danger"
                                ...
                                <?php else: ?>
                                    <button class="btn"
                                        style="padding: 5px 10px; font-size: 12px; background: #95a5a6; color: white;" disabled
                                        title="Cannot delete - item is used in requests">In Use</button>
                                <?php endif; ?>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
                    <tr>
                        <td colspan="6" style="text-align: center; padding: 20px;">No items found. <a
                                href="add_item.php">Add your first item</a></td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
